...
var DateInput = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:{'input-group' : _vm.bootstrapStyling}},[(_vm.calendarButton)?_c('span',{staticClass:"vdp-datepicker__calendar-button",class:{'input-group-prepend' : _vm.bootstrapStyling},style:({'cursor:not-allowed;' : _vm.disabled}),on:{"click":_vm.showCalendar}},[_c('span',{class:{'input-group-text' : _vm.bootstrapStyling}},[_c('i',{class:_vm.calendarButtonIcon},[_vm._v(" "+_vm._s(_vm.calendarButtonIconContent)+" "),(!_vm.calendarButtonIcon)?_c('span',[_vm._v("…")]):_vm._e()])])]):_vm._e(),_vm._v(" "),(_vm.mask)?_c('masked-input',{ref:_vm.refName,class:_vm.computedInputClass,attrs:{"type":_vm.inline ? 'hidden' : 'text',"name":_vm.name,"id":_vm.id,"value":_vm.formattedValue,"mask":_vm.mask,"open-date":_vm.openDate,"clear-button":_vm.clearButton,"placeholder":_vm.placeholder,"disabled":_vm.disabled,"required":_vm.required},on:{"input":function (value) { return _vm.tempValue = value; }},nativeOn:{"click":function($event){return _vm.showCalendar($event)},"keyup":function($event){return _vm.parseTypedDate($event)},"blur":function($event){return _vm.inputBlurred($event)}}}):_c('input',{ref:_vm.refName,class:_vm.computedInputClass,attrs:{"name":_vm.name,"id":_vm.id,"open-date":_vm.openDate,"clear-button":_vm.clearButton,"disabled":_vm.disabled,"required":_vm.required,"readonly":!_vm.typeable},domProps:{"value":_vm.formattedValue},on:{"input":function (value) { return _vm.tempValue = value; },"click":_vm.showCalendar,"keyup":_vm.parseTypedDate,"blur":_vm.inputBlurred}}),_vm._v(" "),(_vm.clearButton && _vm.selectedDate)?_c('span',{staticClass:"vdp-datepicker__clear-button",class:{'input-group-append' : _vm.bootstrapStyling},on:{"click":function($event){_vm.clearDate();}}},[_c('span',{class:{'input-group-text' : _vm.bootstrapStyling}},[_c('i',{class:_vm.clearButtonIcon},[(!_vm.clearButtonIcon)?_c('span',[_vm._v("×")]):_vm._e()])])]):_vm._e(),_vm._v(" "),_vm._t("afterDateInput")],2)},staticRenderFns: [],
  props: {
    selectedDate: Date,
    resetTypedDate: [Date],
  ...
  methods: {
    ...
    parseTypedDate: function parseTypedDate (event) {
      ...
      if (!this.confirmOnEnter) {
        if (this.typeable && isNeedParse(this.tempValue, this.mask)) {
          var typedDate$1 = this.parseDate(this.tempValue);
          if (typedDate$1) {
            // this.typedDate = this.input.value
            this.$emit('typedDate', new Date(typedDate$1));
          }
        }
      }
    ...
    focus: function focus () {
      var input = this.$refs[this.refName];
      if (this.mask) {
        input.$el.focus();
        input.$el.click();
      } else {
